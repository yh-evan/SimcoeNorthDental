...
export default function DoctorInfoUpdate(){

    const location = useLocation();
    const history = useHistory();
    
    const user = location.state.user;
    const { first_name, last_name, email_address, cell_phone, emp_id, role } = user;
    console.log(user);
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            ...
            fetch(`https://test-doctor-api.herokuapp.com/api/doctors/${id}`, {
                method: "PUT",
                headers: {
