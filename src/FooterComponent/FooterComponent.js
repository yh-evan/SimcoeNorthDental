...
function FooterComponent() {
  return (
    <div className="FooterComponent">
      <div className="FooterComponent-mask"></div>
      <div className="FooterComponent-main">
        ...
        <div className="FooterComponent-Practice">
          <h2>Practice</h2>
          <a className="pratice" href="#Home" target="_blank">
            Home
          </a>
          <a className="pratice" href="#About" target="_blank">
            About
          </a>
          <a className="pratice" href="#Patients" target="_blank">
            New Patients
          </a>
          <a className="pratice" href="#Contact" target="_blank">
            Contact Us
          </a>
        </div>
        {/* Colum3 */}
