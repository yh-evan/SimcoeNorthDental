  ...
  return (
    <div className="intro">
      ...
      <div className="intro-title">
        ...
        <h7>
          Family dentistry is a term for a dentist that can provide care for
          your entire family. As we age, our dental needs are different, which
          is why a family dentist is so important. From teaching the proper ways
          to brush and floss to catching dental problems before they become a
          major issue, your family dentist has a lot to offer. Aside from
          offering dental exams, your family dentist will also recommend that
          you schedule dental cleanings for the entire family every six months
          to help keep your smile’s bright. The family dentist has access to
          dental tools that can provide a deeper clean than you can on your own
          at home to ensure your mouth stays healthy. Are you looking for a
          dental practice that can treat your entire family? If so, visit our
          family dentist in Scarborough today.{" "}
        </h7>
      </div>
        ...
        <div className="intro-card">
          <div className="intro-card-img">
            <img
              ...
              alt="cleaning and gum diseases"
            ></img>
          </div>
          <div className="intro-card-text">
            <h5>Teeth cleaning and gum diseases</h5>
            <p>
      ...
      <div className="intro-content">
        <div className="intro-card">
          ...
          <div className="intro-card-img">
            <img
              src="/img/services photoes/fillings.jpg"
              alt="cleaning and gum diseases"
            ></img>
          </div>
        </div>
      ...
      <div className="intro-content">
        <div className="intro-card">
          <div className="intro-card-img">
            <img
              src="/img/services photoes/extractions.jpg"
              alt="cleaning and gum diseases"
            ></img>
          </div>
          <div className="intro-card-text">
      ...
      <div className="intro-content">
        <div className="intro-card">
          <div className="intro-card-text">
            <h5>Sedation</h5>
            <p>
              Sedation is the reduction of irritability or agitation by
              administration of sedative drugs, generally to facilitate a
              medical procedure or diagnostic procedure. Examples of drugs which
              can be used for sedation include isoflurane, diethyl ether,
              propofol, etomidate, ketamine, pentobarbital, lorazepam and
              midazolam.
            </p>
          </div>
          <div className="intro-card-img">
      ...
      <div className="intro-content">
        <div className="intro-card">
          <div className="intro-card-img">
            <img
              src="/img/services photoes/crown.jpg"
              alt="cleaning and gum diseases"
            ></img>
          </div>
          <div className="intro-card-text">
            <h5>Crowns and Veneers</h5>
            <p>
      ...
      <div className="intro-content">
        <div className="intro-card">
          ...
          <div className="intro-card-img">
            <img
              src="/img/services photoes/root canal.jpg"
              alt="cleaning and gum diseases"
            ></img>
          </div>
        </div>
      ...
      <div className="intro-content" id="whitening">
        <div className="intro-card">
          <div className="intro-card-img">
            <img
          ...
          <div className="intro-card-text">
            ...
            <p>
              ...
              from our dentists’ supervision. Night guards and retainers: we
              also provide customized night guards and retainers for your needs.
              Please consult our dental team regarding the indications.
            </p>
          </div>
        </div>
      </div>
